...
while admin_input != "close":
    if Ticket.select().where(Ticket.is_problem_fixed == 0).exists():
        ...
        for entry in query:
            # limit string length for answer
        ...
        while admin_input != "close" and admin_input != "" and admin_input != "4" and admin_input != "refresh":
            ...
            while admin_input != "close" and admin_input != "" and admin_input != "4" and admin_input != "refresh":
                ...
                if admin_input == "1":
                    ...
                    mark_ticket_as_resolved = Ticket.update(
                        {Ticket.is_problem_fixed: True}).where(Ticket.id == str(entry))
                    mark_ticket_as_resolved.execute()
